...
public class PropertiesDialog extends JDialog implements ActionListener, ChangeListener
{
    ...
    public PropertiesDialog(Frame owner, Properties props, boolean editable, Properties result)
    {
        ...
        this.result = result;
        initialize();
        columns.setValue(Integer.valueOf(props.getColumns()));
        //((JSpinner.DefaultEditor)columns.getEditor()).getTextField().selectAll();
        rows.setValue(Integer.valueOf(props.getRows()));
        generations.setValue(Integer.valueOf(props.getGenerations()));
        getPeriod1().setValue(Integer.valueOf(props.getPeriod(1)));
        getPeriod2().setValue(Integer.valueOf(props.getPeriod(2)));
        getPeriod3().setValue(Integer.valueOf(props.getPeriod(3)));
        getPeriod4().setValue(Integer.valueOf(props.getPeriod(4)));
        getPeriod5().setValue(Integer.valueOf(props.getPeriod(5)));
        getPeriod6().setValue(Integer.valueOf(props.getPeriod(6)));
        ...
        tileAfterShiftRight.setValue(Integer.valueOf(props.getTileGenShiftRight()));
        tileAfterShiftDown.setValue(Integer.valueOf(props.getTileGenShiftDown()));
        ...
        tileRightShiftDown.setValue(Integer.valueOf(props.getTileHorzShiftDown()));
        tileRightShiftFuture.setValue(Integer.valueOf(props.getTileHorzShiftFuture()));
        ...
        tileBelowShiftRight.setValue(Integer.valueOf(props.getTileVertShiftRight()));
        tileBelowShiftFuture.setValue(Integer.valueOf(props.getTileVertShiftFuture()));
